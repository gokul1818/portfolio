...
export const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 p-6 bg-[#fea6ab55] text-white rounded-lg shadow-md md:w-3/5 w:sm-96  mx-auto">
        {/* Image Section */}
        ...
        <div className="w-full md:w-1/2  ">
          ...
          >
            ...
            <motion.button
              type="submit"
              className="bg-gray-800  hover:bg-gray-900 cursor-pointer text-white font-semibold py-2 rounded-md transition-all"
            >
              Send Message
            </motion.button>
          </form>
